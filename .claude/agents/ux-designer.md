...
## Purpose
Design intuitive user interfaces, optimize user workflows, ensure accessibility.

## When to Use
- Designing GUI layouts and perspectives
...
2. Design interface layouts (wireframes, perspectives)
3. Validate accessibility and usability
4. Review implementation for UX consistency
...
- Review implementation for UX consistency
